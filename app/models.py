...
class Ficha_fisica(TimeStampMixin, models.Model):
    ...
    medida_tricpes_direito = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    medida_tricpes_esquerdo = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    ...
    medida_antibraco_direito = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    medida_antibraco_esquerdo = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
